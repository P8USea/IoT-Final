 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2y$08$.PI/bes6hkQtp4rsWckx3.02aLSyHJ.B/OTD3KVJ3eds5A2eXvxFe",
            permissions: "*"
        }]
    },
    ...
    https: {
      key: require("fs").readFileSync('/home/ubuntu/server.key'),
      cert: require("fs").readFileSync('/home/ubuntu/server.cert')
    },
